...
// Import specific types from react-hook-form for better type safety
        ...
        <div className="space-y-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <FormInput id="Dependents" label="Dependents (0-3)" register={register} error={errors.Dependents} type="number" />
              ...
              <FormInput id="Credit_History" label="Credit History (1=Yes, 0=No)" step="1" register={register} error={errors.Credit_History} type="number" />
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <FormInput id="ApplicantIncome" label="Applicant Income" register={register} error={errors.ApplicantIncome} type="number" />
              <FormInput id="CoapplicantIncome" label="Co-applicant Income" register={register} error={errors.CoapplicantIncome} type="number" />
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <FormInput id="LoanAmount" label="Loan Amount (in thousands)" register={register} error={errors.LoanAmount} type="number" />
              <FormInput id="Loan_Amount_Term" label="Loan Term (in months)" register={register} error={errors.Loan_Amount_Term} type="number" />
            </div>
